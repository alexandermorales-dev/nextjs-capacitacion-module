...
export default function CertificateVerificationPage() {
  ...
  const [carnetPdfReady, setCarnetPdfReady] = useState<{ [key: number]: boolean }>({});
      ...
      try {
        ...
        if (carnetsResponse.ok) {
          ...
          if (carnetsData.success && carnetsData.data) {
            ...
            carnetsData.data.forEach((c: Carnet) => { ready[c.id] = true; });
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-white">Verificación de Certificados</h1>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                >
                  <div className="flex flex-col items-center justify-center py-12 space-y-4 bg-gray-50 rounded">
                    <p className="text-gray-600 text-sm text-center px-4">Tu dispositivo no puede previsualizar el PDF directamente.</p>
                    <a
                      href={certPdfUrl}
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-6 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-6 space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Detalles del Carnet</h3>
                {carnets.map((carnet, index) => (
                  <div key={carnet.id} className={`border border-gray-200 rounded-lg p-4 ${index > 0 ? 'mt-2' : ''}`}>
                    ...
                    <div key={carnet.id} className="border border-gray-200 rounded-lg p-4">
                      ...
                      >
                        <div className="flex flex-col items-center justify-center py-10 space-y-3 bg-gray-50 rounded">
                          <p className="text-gray-600 text-sm text-center px-4">Tu dispositivo no puede previsualizar el PDF.</p>
                          <a
                            href={`/api/generate-carnet-pdf/${carnet.id}`}
